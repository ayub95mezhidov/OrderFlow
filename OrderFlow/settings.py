...
if not SECRET_KEY:
    # Резервный ключ только для разработки
    SECRET_KEY = 'dS66w3xt8AHPiCGhDbS6qDexa0OF-xHlmFhXBosRFUwVL7ZJbPNYJzn-cc4jC27j29g'
    print("ВНИМАНИЕ: Используется временный SECRET_KEY!")
